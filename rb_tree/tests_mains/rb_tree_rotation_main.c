...
void	check_branches(t_rb_node *root)
{
	t_rb_node *current;
	t_rb_node *copy_root;
...
int	main(int argc __attribute__((unused)), char *argv[] __attribute__((unused)))
{
	...
	//ok with null input.
	rb_tree_left_rotation(&root->right);
	rb_tree_debug(root, display_func);
	rb_tree_right_rotation(&root->right->left);
	rb_tree_debug(root, display_func);
	rb_tree_left_rotation(&root->left);
	rb_tree_debug(root, display_func);
	rb_tree_right_rotation(&root->left);
	rb_tree_debug(root, display_func);

...
int	main(int argc __attribute__((unused)), char *argv[] __attribute__((unused)))
{
	...
	rb_tree_del(&root, &number3, cmp_func, free_func);
	rb_tree_debug(root, display_func);
	printf("deleting all the 4s at once:\n");
	rb_tree_del(&root, &number4, cmp_func, free_func);
	rb_tree_debug(root, display_func);
	printf("deleting all the NULL:\n");
	rb_tree_del(&root, NULL, cmp_func, free_func);
	rb_tree_debug(root, display_func);
	printf("deleting 0:\n");
	rb_tree_del(&root, &number0, cmp_func, free_func);
	rb_tree_debug(root, display_func);
	printf("deleting 9:\n");
	rb_tree_del(&root, &number9, cmp_func, free_func);
	rb_tree_debug(root, display_func);
	printf("deleting 10:\n");
	rb_tree_del(&root, &number10, cmp_func, free_func);
	rb_tree_debug(root, display_func);
	printf("deleting 12:\n");
	rb_tree_del(&root, &number12, cmp_func, free_func);
	rb_tree_debug(root, display_func);
	printf("deleting 16:\n");
	rb_tree_del(&root, &number16, cmp_func, free_func);
	rb_tree_debug(root, display_func);
	printf("deleting 15:\n");
	rb_tree_del(&root, &number15, cmp_func, free_func);
	rb_tree_debug(root, display_func);
	printf("deleting 13:\n");
	rb_tree_del(&root, &number13, cmp_func, free_func);
	rb_tree_debug(root, display_func);
	printf("deleting 2:\n");
	rb_tree_del(&root, &number2, cmp_func, free_func);
	rb_tree_debug(root, display_func);

	/*
	printf("now adding some sixes...\n");
	rb_tree_add(&root, node60, cmp_func);
	rb_tree_add(&root, node61, cmp_func);
	rb_tree_add(&root, node62, cmp_func);
	rb_tree_add(&root, node63, cmp_func);
	rb_tree_add(&root, node64, cmp_func);
	rb_tree_add(&root, node65, cmp_func);
	rb_tree_debug(root, display_func);
	*/
	printf("deleting 6:\n");
	rb_tree_del(&root, &number6, cmp_func, free_func);
	rb_tree_debug(root, display_func);
	printf("deleting 1:\n");
	rb_tree_del(&root, &number1, cmp_func, free_func);
	rb_tree_debug(root, display_func);
	printf("deleting 5:\n");
	rb_tree_del(&root, &number5, cmp_func, free_func);
	rb_tree_debug(root, display_func);
	printf("deleting 7:\n");
	rb_tree_del(&root, &number7, cmp_func, free_func);
	rb_tree_debug(root, display_func);
	printf("deleting 14:\n");
	rb_tree_del(&root, &number14, cmp_func, free_func);
	rb_tree_debug(root, display_func);
	printf("deleting 11:\n");
	rb_tree_del(&root, &number11, cmp_func, free_func);
	rb_tree_debug(root, display_func);
	printf("size = %d\n", rb_tree_size(root));
	printf("deleting 8:\n");
	rb_tree_del(&root, &number8, cmp_func, free_func);
	rb_tree_debug(root, display_func);
	printf("deleting 9:\n");
	rb_tree_del(&root, &number9, cmp_func, free_func);
	rb_tree_debug(root, display_func);

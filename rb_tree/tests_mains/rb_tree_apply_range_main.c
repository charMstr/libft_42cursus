...
int	main(int argc __attribute__((unused)), char *argv[] __attribute__((unused)))
{
	...
	rb_tree_debug(root, display_func);
	printf("\033[32mstarting the apply range func\033[0m\n");
	int number_ref_min;
	int number_ref_max;

	number_ref_min = 5;
	number_ref_max = 15;
	range.item_ref_min = &number_ref_min;
	range.item_ref_max = &number_ref_max;
	printf("result of apply_range: %d\n", rb_tree_apply_range(&root, &range, cmp_func, apply_func));

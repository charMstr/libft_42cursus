...
int	main(int argc __attribute__((unused)), char *argv[] __attribute__((unused)))
{
	...
	*/
	...
	//rb_tree_debug(root, display_func);
	//rb_tree_getnode(&root, &number1, cmp_func, free_func);
	//rb_tree_getnode(&root, NULL, cmp_func, free_func);
	//rb_tree_getnode(&root, &number1, cmp_func, free_func);
	rb_tree_debug(root, display_func);
	printf("\n\033[32mGETTING:\033[0m\n\n");
	rb_tree_getnode(&root, &number2, cmp_func);
	rb_tree_getnode(&root, &number5, cmp_func);
	rb_tree_getnode(&root, &number7, cmp_func);
	rb_tree_getnode(&root, &number9, cmp_func);
	rb_tree_getnode(&root, &number4, cmp_func);
	rb_tree_getnode(&root, &number4, cmp_func);
	rb_tree_getnode(&root, &number4, cmp_func);
	rb_tree_getnode(&root, &number4, cmp_func);
	rb_tree_getnode(&root, &number4, cmp_func);
	rb_tree_getnode(&root, &number4, cmp_func);
	rb_tree_debug(root, display_func);
	//rb_tree_getnode(&root, &number6, cmp_func, free_func);
	//rb_tree_debug(root, display_func);
	//rb_tree_getnode(&root, NULL, cmp_func, free_func);
	//rb_tree_debug(root, display_func);
	printf("getting: 3\n");
	rb_tree_getnode(&root, &number3, cmp_func);
	rb_tree_debug(root, display_func);
	printf("getting: 3\n");
	rb_tree_getnode(&root, &number3, cmp_func);
	rb_tree_debug(root, display_func);
	...
	rb_tree_debug(root, display_func);
	printf("getting: 1\n");
	rb_tree_getnode(&root, &number1, cmp_func);
	rb_tree_debug(root, display_func);
	printf("getting: 0\n");
	rb_tree_getnode(&root, &number0, cmp_func);
	rb_tree_debug(root, display_func);
	return (0);
}

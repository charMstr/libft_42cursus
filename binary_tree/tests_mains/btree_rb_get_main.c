...
int	main(int argc __attribute__((unused)), char *argv[] __attribute__((unused)))
{
	...
	*/
	...
	//btree_rb_debug(root, display_func);
	//btree_rb_get(&root, &number1, cmp_func, free_func);
	//btree_rb_get(&root, NULL, cmp_func, free_func);
	//btree_rb_get(&root, &number1, cmp_func, free_func);
	btree_rb_debug(root, display_func);
	printf("\n\033[32mGETTING:\033[0m\n\n");
	btree_rb_get(&root, &number2, cmp_func);
	btree_rb_get(&root, &number5, cmp_func);
	btree_rb_get(&root, &number7, cmp_func);
	btree_rb_get(&root, &number9, cmp_func);
	btree_rb_get(&root, &number4, cmp_func);
	btree_rb_get(&root, &number4, cmp_func);
	btree_rb_get(&root, &number4, cmp_func);
	btree_rb_get(&root, &number4, cmp_func);
	btree_rb_get(&root, &number4, cmp_func);
	btree_rb_get(&root, &number4, cmp_func);
	btree_rb_debug(root, display_func);
	//btree_rb_get(&root, &number6, cmp_func, free_func);
	//btree_rb_debug(root, display_func);
	//btree_rb_get(&root, NULL, cmp_func, free_func);
	//btree_rb_debug(root, display_func);
	printf("getting: 3\n");
	btree_rb_get(&root, &number3, cmp_func);
	btree_rb_debug(root, display_func);
	printf("getting: 3\n");
	btree_rb_get(&root, &number3, cmp_func);
	btree_rb_debug(root, display_func);
	...
	btree_rb_debug(root, display_func);
	printf("getting: 1\n");
	btree_rb_get(&root, &number1, cmp_func);
	btree_rb_debug(root, display_func);
	printf("getting: 0\n");
	btree_rb_get(&root, &number0, cmp_func);
	btree_rb_debug(root, display_func);
	return (0);
}
